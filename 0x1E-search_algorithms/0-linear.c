...
/**
  * linear_search - Conducts a linear search for
  * a value within an array of integers.
  ...
  *
  * Description: Displays the value at each positioning
  * the array as it is checked.
  */
